"""
setup_imports.py - A reusable import helper
This can be imported at the top of any new scraper file to enable scraping_hub access.
Setup imports for scraping_hub framework

Import this file at the top of your BLS scraper files to enable scraping_hub imports:
